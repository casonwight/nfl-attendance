...
The Chargers had the smallest impact, becuase they had such low attendance in the first place.
...
```{r revenue_results}
post_predicted_loss_attendance <- get_post_predicted_lost_attendance(post_predicted_attendance, attendance_2020, team_names, "All teams")
