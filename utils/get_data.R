...
get_team_revenue_data <- function(team_names, team_cities) {
  ...
  # }
  # close(pb)
  # revs <- do.call(rbind, revenues)
  
  return(revs)
}

get_average_ticket_price_data <- function() {
  price_data <- read.csv("data/average_ticket_price_data.csv")
...
get_attendance_data <- function(){
  data_reshape <- read.csv("data/attendance.csv")
...
get_2020_attendance_data <- function(attendance_data) {
  attendance_2020 <- read.csv("data/attendance_2020.csv")
